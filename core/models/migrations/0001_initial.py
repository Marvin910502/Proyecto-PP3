    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descripcion', models.TextField(blank=True, null=True, verbose_name='Descripción')),
                ('fecha_comienzo', models.DateTimeField(auto_now_add=True, verbose_name='Fecha de Inicio')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('investigacion', models.ForeignKey( on_delete=django.db.models.deletion.CASCADE, to='models.investigacion', verbose_name='Investigación', null=True, blank=True)),
